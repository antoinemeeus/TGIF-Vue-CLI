    ...
    <b-container>
      <main class="container-fluid" role="main">
        <div class="row pt-5">
              ...
              <div role="tablist">
                <b-card no-body class="mb-1">
                  <b-card-header header-tag="header" class="p-1" role="tab">
                    <b-btn block href="#" v-b-toggle.accordion1 variant="secondary">About Us</b-btn>
                  </b-card-header>
                ...
                <b-card no-body class="mb-1">
                  <b-card-header header-tag="header" class="p-1" role="tab">
                    <b-btn
                      ...
                      variant="secondary"
                    >Background History of Government Transparency</b-btn>
                  </b-card-header>
          ...
          <div class="col col-lg-5 col-sm-5 align-self-center text-center">
            <img class src="../assets/magnifying_us.jpg" alt="Magnifying Glass on Government">
          </div>
        </div>
      </main>
    </b-container>
